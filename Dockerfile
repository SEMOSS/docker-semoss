#docker build . -t quay.io/semoss/docker:cuda
...
RUN	wget https://downloads.rclone.org/v1.60.0/rclone-v1.60.0-linux-amd64.deb \
	...
	&& echo "export LD_PRELOAD=/usr/lib/python3.8/config-3.8-x86_64-linux-gnu/libpython3.8.so" >> $TOMCAT_HOME/bin/setenv.sh \
